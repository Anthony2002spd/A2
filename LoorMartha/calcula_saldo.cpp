...
{//Abrimos llave
	float MPLA_x,MPLA_s=0;//Usamos float para representar un caracter y declaramos las variables flotantes x y s
	int MPLA_i=0,MPLA_l;//Usamos int para ingresar los enteros y declaramos las variables i y l
	cout<<"Ingrese cantidad de egresos (l): ";cin>>MPLA_l;//Usamos cout para pedir un valor y cin para que el usuario lo ingrese
	cout<<"Ingrese saldo inicial (s): ";cin>>MPLA_s;//Usamos cout para pedir un valor y cin para que el usuario lo ingrese
	
	do{//Usamos do-while para repetir una instruccion
	cout<<"Ingrese egreso(x): ";cin>>MPLA_x;//Usamos cout para pedir un valor y cin para que el usuario lo ingrese
	...
	cout<<"El saldo final es: "<<MPLA_s<<endl;//Presentamos por pantalla el resultado final
